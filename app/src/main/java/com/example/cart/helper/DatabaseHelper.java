...
db.execSQL("CREATE TABLE " + table_name + " (" + id +" INTEGER PRIMARY KEY, " + name + " varchar(50), " + price + " varchar(50), " + quantity + " varchar(50))");
    }
...
onCreate(db);
    ...
    public void insertData(String id,String name,String price,String quantity){
        SQLiteDatabase database = getWritableDatabase();
        String sql = "INSERT INTO " + table_name + "(id,name,price,quantity)VALUES(?,?,?,?)";
    ...
    public void updateData(String id,String quantity){
        SQLiteDatabase database = getWritableDatabase();
